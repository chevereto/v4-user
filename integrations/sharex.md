...
[ShareX](https://en.wikipedia.org/wiki/ShareX) is an utility for Windows that allows you to upload media, screen captures, text and other kind of content to several providers. You can easily use ShareX with your Chevereto website to upload media directly from your computer thanks to the [Chevereto API V1](https://v4-docs.chevereto.com/developer/api/api-v1.html).
...
## Upload media to a user account
